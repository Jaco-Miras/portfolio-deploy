    ...
    <div name="home" className="bg-[#EEEEEE] w-full h-screen">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <p className="text-[#3A3845] py-4 max-w-[700px]">
          I am a fresh graduate with a fresh mind that is willing to learn
          another skillset of programming, development and has a enthusiast of
          coding especially in frontend development.
        </p>
        {/* <div>
