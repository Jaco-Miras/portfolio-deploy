...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#EB5353] text-white">
      <div>
        <img
          src={Logo}
          alt="Logo"
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-[#EB5353] flex flex-col justify-center items-center"
        }
      >
        <li className="py-5 text-2xl">Home</li>
        <li className="py-5 text-2xl">About</li>
        <li className="py-5 text-2xl">Skills</li>
        <li className="py-5 text-2xl">Works</li>
        <li className="py-5 text-2xl">Contact Me</li>
      </ul>
